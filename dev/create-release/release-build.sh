...
PUBLISH_PROFILES="-Pmesos -Pyarn -Pkubernetes -Pnomad -Pflume $HIVE_PROFILES -Pspark-ganglia-lgpl -Pkinesis-asl"
# Profiles for building binary releases
BASE_RELEASE_PROFILES="-Pmesos -Pyarn -Pkubernetes -Pnomad -Pflume -Psparkr"
